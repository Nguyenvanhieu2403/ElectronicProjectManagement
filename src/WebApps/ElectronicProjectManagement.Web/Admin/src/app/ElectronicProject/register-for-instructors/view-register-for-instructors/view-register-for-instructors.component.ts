...
@Component({
  selector: 'app-view-register-for-instructors',
  templateUrl: './view-register-for-instructors.component.html',
  styleUrls: ['./view-register-for-instructors.component.css'],
})
export class ViewRegisterForInstructorsComponent
  ...
  implements OnInit
{
  ...
  constructor(
    protected _service: ProjectsTeachersStudentsService,
  ...
  getList() {
    const model = {
      idTeacher: this.itemSelected.id,
      idProjectBatch: this.itemSelected.idProjectBatch,
      pageIndex: this.pageIndex,
      pageSize: this.pageSize,
    };
    this._service.getStudentRegister(model).then(
      (res) => {

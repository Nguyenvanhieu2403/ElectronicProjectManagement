...
export class ProjectManagerComponent
  ...
  implements OnInit
{
  @ViewChild('pCreate', { static: false }) pCreate: AddProjectManagerComponent;
  @ViewChild('pEdit', { static: false }) pEdit: EditProjectManagerComponent;
  @ViewChild('pImport', { static: false })
  pImport: ImportProjectManagerComponent;
  formGroup: any;
  currentUnitCode: any = '';
  setWidth: string = '100%';
  dataMotion: any;
